class HystrixCircuitBreakerGrailsPlugin {
    ...
    def title = "Hystrix Circuit Breaker Plugin" // Headline display name of the plugin
    def author = "Demian Neidetcher"
    def authorEmail = "demian0311@gmail.com"
    def description = '''\
Hystrix is awesome, this is an attempt to make it easy to use for a Grails application.
'''
